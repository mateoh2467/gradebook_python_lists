...
gradebook = [100, "Variables Test", 75, "Variables Homework"]
...
def main():
    ...
    while True: 
        user_input = input("What would you like to do? [Add] or [Remove] Grade or [Print] of type [exit] to quit: ").lower()
        if(user_input == "add"):
            assignment_input = input("Please enter the assignment name: ")
            grade_input = input("Please enter grade: ")
